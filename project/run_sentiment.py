...
class CNNSentimentKim(minitorch.Module):
    ...
    3. Apply a Linear to size C (number of classes) with Dropout with rate 25%
    4. Apply a sigmoid
    """
    ...
    def __init__(
        ...
        k1, k2, k3 = filter_sizes
        self.conv1 = Conv1d(embedding_size, feature_map_size, k1)
        self.conv2 = Conv1d(embedding_size, feature_map_size, k2)
        self.conv3 = Conv1d(embedding_size, feature_map_size, k3)
    ...
    def forward(self, embeddings):
        ...
        # Apply a 1d convolution (batch, sentence length, feature_map_size)
