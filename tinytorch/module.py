...
class Module:
    ...
    def named_parameters(self) -> typing.List[tuple]:
        """
        ...
        """
        descendant_params = [
            (f"{descendant_name}.{param_name}", param)
            for descendant_name, module in self._modules.items()
            for param_name, param in module.named_parameters()
        ]

        return list(self._parameters.items()) + descendant_params
